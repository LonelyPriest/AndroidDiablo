...
public class RetailerAdapter extends ArrayAdapter<Retailer> {
    ...
    List<Retailer> items, tempItems, suggestions;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            view = inflater.inflate(R.layout.typeahead_retailer, parent, false);
        }

        Retailer people = items.get(position);
        if (people != null) {
            TextView lblName = (TextView) view.findViewById(R.id.typeahead_select_retailer);
            if (lblName != null)
